    ...
    include('connect.php');
        ...
        if($answer == NULL){
            ...
            if(mysqli_query($conn,$que)){
                echo "<style>#searchbox{display: none;} #taa{display: block;}</style>";
            }
            else
...
<html>
  ...
  <div id="content" >
            ...
            <?php
                ...
                if(isset($_POST["submit"])) {
                    ...
                    if($text == NULL){
                        ...
                        $words = explode(" ",$text);
                        $format = "select * from search where question like '%";
                        $query = "";
            ...
            <?php $n = 1; $nul=0; while( $row = mysqli_fetch_assoc($r) ) { ?>
                        ...
                        <div id="qa-block">
                            <div class="question">
                                <div id="Q">Q.</div><?php echo $row["question"]."<small id='sml'>Asked By: @".$row['askedby']." </small><div style='float:right;'> Upvotes ".$row['upvote']."</div>"; 
