            ...
            <div id="sf">
                <center>
                    ...
                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <i class="material-icons" id="lock"></i>
                        <i class="material-icons" id="person"></i>
                        ...
                        <input name="age" id="name" type="text" title="Your age" placeholder="Age" required>
                        <input name="email" id="mailbox" type="email" title="Your Email id is in safe hands." placeholder="Enter your Email Id" required>
                         <i class="material-icons" id="age"></i>
                        <i class="material-icons" id="email"></i>
                        <i class="material-icons" id="iden"></i>
...
$age=valid($_POST["age"]);
                ...
                $query = "INSERT INTO users values( NULL, '$username', '$password', '$name', '$email', CURRENT_TIMESTAMP ,'$age');";
...
//                
                   ...
                   if( mysqli_error($conn)=="Improper age")
                    echo "<script>window.alert('Insert proper age');</script>";
